package com.firstapp.navigationdrawer.ui.profiles;
...
public class ProfilesFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final TextView textView = root.findViewById(R.id.text_profiles);
        profilesViewModel.getText().observe(getViewLifecycleOwner(), new Observer<String>() {
            @Override
